...
for key in AWS_OCR_CONTROL_ENABLED AWS_REGION AWS_OCR_QUEUE_URL AWS_OCR_START_LAMBDA AWS_ACCESS_KEY_ID AWS_SECRET_ACCESS_KEY APP_SIGNING_SECRET POSTGRES_PRISMA_URL BLOB_READ_WRITE_TOKEN; do
